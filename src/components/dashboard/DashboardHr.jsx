...
export default function DashboardHr() {
  ...
  // Updated JSON Data
  const tradeData = [
    { trade: "TA+", count: 50, below35: 20, age35to45: 15, above45: 15, date: "2025-01-15" },
    { trade: "FM", count: 40, below35: 15, age35to45: 15, above45: 10, date: "2025-02-01" },
    { trade: "CM", count: 45, below35: 20, age35to45: 15, above45: 10, date: "2025-03-10" },
    { trade: "HSK I", count: 30, below35: 10, age35to45: 10, above45: 10, date: "2025-01-20" },
    { trade: "HSK II", count: 35, below35: 15, age35to45: 10, above45: 10, date: "2025-02-15" },
    { trade: "SK", count: 55, below35: 25, age35to45: 20, above45: 10, date: "2025-03-01" },
    { trade: "TMM", count: 45, below35: 15, age35to45: 15, above45: 15, date: "2025-04-01" },
  ];

  const trrdData = [
    { type: "Transfer", trade: "TA+", count: 10, below35: 5, age35to45: 3, above45: 2, date: "2025-01-20" },
    { type: "Retirement", trade: "FM", count: 8, below35: 2, age35to45: 2, above45: 4, date: "2025-02-05" },
    { type: "Resignation", trade: "CM", count: 12, below35: 5, age35to45: 5, above45: 2, date: "2025-03-15" },
    { type: "Death", trade: "HSK I", count: 5, below35: 1, age35to45: 2, above45: 2, date: "2025-01-25" },
    { type: "Transfer", trade: "HSK II", count: 7, below35: 3, age35to45: 2, above45: 2, date: "2025-02-20" },
    { type: "Retirement", trade: "SK", count: 9, below35: 3, age35to45: 3, above45: 3, date: "2025-03-05" },
    { type: "Resignation", trade: "TMM", count: 10, below35: 4, age35to45: 3, above45: 3, date: "2025-04-05" },
  ];

  const healthData = [
    { status: "Medical Pending", count: 25, below35: 10, age35to45: 8, above45: 7, date: "2025-01-10" },
    { status: "HT", count: 15, below35: 5, age35to45: 5, above45: 5, date: "2025-02-15" },
    { status: "DIAB", count: 12, below35: 4, age35to45: 4, above45: 4, date: "2025-03-20" },
    { status: "HT + DIAB", count: 8, below35: 3, age35to45: 2, above45: 3, date: "2024-12-30" },
  ];

  const awardsData = [
    { type: "Excellence", trade: "TA+", count: 5, below35: 2, age35to45: 2, above45: 1, date: "2025-01-05" },
    { type: "Innovation", trade: "FM", count: 4, below35: 2, age35to45: 1, above45: 1, date: "2025-02-10" },
    { type: "Leadership", trade: "CM", count: 5, below35: 2, age35to45: 2, above45: 1, date: "2025-03-05" },
    { type: "Teamwork", trade: "HSK I", count: 3, below35: 1, age35to45: 1, above45: 1, date: "2025-01-15" },
    { type: "Excellence", trade: "HSK II", count: 4, below35: 2, age35to45: 1, above45: 1, date: "2025-02-20" },
    { type: "Innovation", trade: "SK", count: 5, below35: 2, age35to45: 2, above45: 1, date: "2025-03-10" },
    { type: "Leadership", trade: "TMM", count: 4, below35: 1, age35to45: 2, above45: 1, date: "2025-04-01" },
  ];
  ...
  useEffect(() => {
    setChartData({
      pie: [
        { category: "HR", sanction: 500, borne: 300, colorStart: "#FF6349", colorEnd: "#B22222", label: "Human Resources" },
        { category: "AOB", sanction: 100, borne: 70, colorStart: "#1E90FF", colorEnd: "#0000CD", label: "Administrative Officer Battalions" },
        { category: "NDV", sanction: 200, borne: 150, colorStart: "#FFD700", colorEnd: "#FFA500", label: "Network Development" },
        { category: "OWC", sanction: 150, borne: 100, colorStart: "#FFFFFF", colorEnd: "#F5F5F5", label: "Operational Warfare Center" },
        { category: "NRW", sanction: 120, borne: 80, colorStart: "#FF6347", colorEnd: "#B22222", label: "Navigation Repair Workshop" },
      ],
      bar: [
        { category: "2018", Industrial: 20, NonIndustrial: 10 },
        { category: "2019", Industrial: 25, NonIndustrial: 15 },
        { category: "2020", Industrial: 30, NonIndustrial: 20 },
        { category: "2021", Industrial: 35, NonIndustrial: 25 },
        { category: "2022", Industrial: 40, NonIndustrial: 30 },
        { category: "2023", Industrial: 45, NonIndustrial: 35 },
      ],
    });
  }, []);
